function [ imageRec, R , iter] = Q4_mod_csi_focus_algo(obj, ill, ill_bent, N, input_num, noise, algo)
%%%
% 
% This function generates a compressed signal using a ground truth object
% and bent fibre wavefront. Then, it reconstruct a super-resolution image
% using the compressed signal and expected straight fibre illumination.
% 
% Inputs:
%     obj: ground truth object
%     ill: straight fibre illumination
%     ill_bent: bent fibre illumination
...
ill_bent_update = sub_ill(N, input_num, ill_bent);

%% Calculate signal from illumination matrix
signal = signal_calc(ill_bent_update, obj, noise, input_num);
...
% Calculate the correlation coefficient over the surface of the core
